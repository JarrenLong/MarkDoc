...
class MarkDoc {
   ...
   */
  public function generateTOC($tocPage = '', $baseDir = DIRECTORY_SEPARATOR, $saveInDir = DIRECTORY_SEPARATOR) {
    ...
    foreach($allFiles as &$p) {
      // Don't add the table of contents entry to the table of contents (redundant)
